...
<head>
	...
	<?php echo $this->helper->renderCss("fathers-day"); ?>
</head>
<body>
	<div id="wf_widget_countdown">
		...
		<div id="wf_widget_content">
            <?php echo $this->helper->fetchChannel('fathers-day.html'); ?>
		</div>
		<div id="wf_widget_footer">
            <script src='http://cdn.onescreen.net/os/static/apps/2.0/_onescreen.js'></script>
            <div id='os_dmp_embed'></div>
            <script>com.onescreen.widgets.load('17581-69c8b95540e173ab31bd10277815e201', 'os_dmp_embed');
            </script>
