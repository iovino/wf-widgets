...
<head>
	...
	<?php echo $this->helper->renderCss("mothers-day"); ?>
</head>
<body>
	<div id="wf_widget_countdown">
		...
		<div id="wf_widget_content">
            <?php echo $this->helper->fetchChannel('mothers-day.html'); ?>
		</div>
		<div id="wf_widget_footer">
            <script src='http://cdn.onescreen.net/os/static/apps/2.0/_onescreen.js'></script>
            <div id='os_dmp_embed'></div>
            <script>com.onescreen.widgets.load('17580-d6f01a9207bfcddc698135ae1f3142ff', 'os_dmp_embed');
            </script>
