...
<head>
	...
	<?php echo $this->helper->renderCss("spring-fling"); ?>
</head>
<body>
	<div id="wf_widget_countdown">
		<div id="wf_widget_header">
            <a class="wf_header_link" target="_blank" href="http://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&c=20&mc=click&pli=9341170&PluID=0&ord=[timestamp]">
    ...
    <img src="http://bs.serving-sys.com/BurstingPipe/adServer.bs?cn=tf&c=19&mc=imp&pli=9341170&PluID=0&ord=[timestamp]&rtu=-1" border="0" width="1" height="1">
</body>
</html>
