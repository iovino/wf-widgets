...
<head>
    ...
    <?php echo $this->helper->renderCss("spring-fashion"); ?>
</head>
<body>
<div id="wf_widget_countdown">
    ...
    <div id="wf_widget_content">
        <?php echo $this->helper->fetchChannel('spring-fashion.html'); ?>
    </div>
    <div id="wf_widget_footer">
        <script src='http://cdn.onescreen.net/os/static/apps/2.0/_onescreen.js'></script>
        <div id='os_dmp_embed'></div>
        <script>com.onescreen.widgets.load('17298-4c09641e00953173efdc481fec139e06', 'os_dmp_embed');
        </script>
