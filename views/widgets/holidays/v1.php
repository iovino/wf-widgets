...
<head>
	...
	<?php echo $this->helper->renderCss("holidays"); ?>
</head>
<body>
	<div id="wf_widget_countdown">
		...
		<div id="wf_widget_content">
            <?php echo $this->helper->fetchChannel('holidays.html'); ?>
		</div>
		<div id="wf_widget_footer">
            <script src='http://cdn.onescreen.net/os/static/apps/2.0/_onescreen.js'></script>
            <div id='os_dmp_embed'></div>
            <script>com.onescreen.widgets.load('15967-9202693453d39efd5764684aed8d1f47', 'os_dmp_embed');
            </script>
