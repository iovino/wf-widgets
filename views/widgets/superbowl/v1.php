...
<head>
	...
	<?php echo $this->helper->renderCss("superbowl"); ?>
</head>
<body>
	<div id="wf_holiday_countdown">
		<div id="wf_holiday_header">
			<div id="wf_widget_by">Brought to you by <span>Superbowl</span></div>
		</div>
		<div id="wf_holiday_content">
            ...
            <script>com.onescreen.widgets.load('15813-bfe3d04390979c4e2e8258bca0305c80', 'os_dmp_embed');
            </script>
